#ifndef PROJECTONETEXTBOX_MOUSEEVENTS_H
#define PROJECTONETEXTBOX_MOUSEEVENTS_H
...
//    static bool mouseClicked(T& object, sf::RenderWindow& window);
    bool mouseClicked(sf::RectangleShape object, sf::RenderWindow& window);
    // returns true if the mouse clicks anywhere in the window
 //   static bool mouseClicked(sf::RectangleShape window, sf::Event event);
       static bool mouseDSingleClicked(sf::RectangleShape window, sf::Event event);
...
#endif //PROJECTONETEXTBOX_MOUSEEVENTS_H
